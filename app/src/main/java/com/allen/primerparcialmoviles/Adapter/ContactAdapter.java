...
public abstract class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ViewHolder> {
    ...
    public abstract void infoOnClickListener(View v, ContactAdapter.ViewHolder vh,Contact c);
    public abstract void starOnClickListener(View v, ContactAdapter.ViewHolder vh,Contact c);
}
